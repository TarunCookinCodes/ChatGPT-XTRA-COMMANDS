...
- `/ex` – Explore: performs quick analysis.  
- `/ech` – Exchange: simulates interactions.  
- `/expr` – Express: generates creative content.  
- `/ext` – Extend: refreshes or regenerates content.  
- `/exam` – Examine: checks session/system status.
...
- `/GitHub` – Link to @TarunCookinCodes repository.  
- `/rd<min,max>` – Picks a random number between min and max.  
- `/p` – Perform action instead of giving explanation.

---

**How to Apply:**  
1. Open ChatGPT > Tap 2 lines at Top Left Corner > Tap on your Account > Personalization > Custom Instructions  
